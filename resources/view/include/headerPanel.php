        ...
        <div class="container-fluid">
            <nav class="navbar navbar-dark">
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../view/home.php" style="color: white; margin-top: 30px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
