                ...
                <tbody>
                    <tr>
                        <form action="" method="post">
                            ...
                            <td><input type="checkbox" class="form-check-input mt-0" name="UserID" value="<?php echo $userRow['id']; ?>">
                                ...
                                <a class="btn btn-sm btn-warning" data-bs-toggle="modal" name="btnAltertUser" data-bs-target="#alterUser">
